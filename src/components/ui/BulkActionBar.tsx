	...
	return (
		<div
			...
			className={cn(
				...
				"bg-base-100 border border-base-300 shadow-pop rounded-box",
		...
		>
			<button
				...
				className="h-9 w-9 shrink-0 inline-flex items-center justify-center rounded-field text-base-content/50 hover:text-base-content/80 hover:bg-base-200 transition-colors"
			>
				<X className="w-4 h-4" />
			</button>
