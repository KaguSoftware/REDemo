...
export function OfflineBanner() {
	...
	return (
		<div
			role="status"
			className="fixed top-0 inset-x-0 z-[60] flex items-center justify-center gap-2 bg-neutral text-neutral-content text-label font-semibold py-2 px-4 safe-top"
		>
