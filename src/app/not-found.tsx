	...
	return (
		<main className="min-h-[70vh] flex items-center justify-center px-6">
			<div className="max-w-sm text-center">
				...
				<Link
					href="/"
					className="mt-5 inline-flex items-center h-10 px-4 rounded-field bg-primary text-primary-content text-sm font-semibold hover:brightness-110 transition-[filter] duration-150"
				>
					Genel bakışa dön
				</Link>
			</div>
